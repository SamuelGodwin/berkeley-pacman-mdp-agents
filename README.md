...
This, CW1 of this module and one other module (was it the scala ones?) had the yowza that's a lot of files limit when uploading via upload (too many files in the test_cases folder so couldn't include that folder). If this were done via git command line push, it would upload without the limit no problem!
